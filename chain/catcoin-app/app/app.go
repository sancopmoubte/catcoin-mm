...
import (
	...
	claimkeeper "github.com/sancopmoubte/my-mobile-chain/chain/catcoin-app/x/claim/keeper"
	claimmodule "github.com/sancopmoubte/my-mobile-chain/chain/catcoin-app/x/claim/module"
	claimtypes "github.com/sancopmoubte/my-mobile-chain/chain/catcoin-app/x/claim/types"
)

const appName = "CatcoinApp"
...
func init() {
	var err error
	DefaultNodeHome, err = clienthelpers.GetNodeHomeDirectory(".catcoind")
	if err != nil {
		panic(err)
	}
}
...
func NewSimApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		authzkeeper.StoreKey, nftkeeper.StoreKey, group.StoreKey, claimtypes.StoreKey,
	)
	...
	// claim 账户只有既有领取池余额的转出能力，权限表中刻意不包含 Minter。
	app.ClaimKeeper = claimkeeper.NewKeeper(
		runtime.NewKVStoreService(keys[claimtypes.StoreKey]), appCodec, app.AccountKeeper, app.BankKeeper,
	)
	...
	*/
	...
	genesisModuleOrder := []string{
		authtypes.ModuleName, banktypes.ModuleName, claimtypes.ModuleName,
...
func BlockedAddresses() map[string]bool {
	...
	// 领取池只接收创世分配或自愿捐赠的既有 MM；该例外不授予任何铸币权限。
